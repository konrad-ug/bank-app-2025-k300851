...
class TestAccount:
    def test_account_creation(self):
        account = Account("John", "Doe", "87060979383")
    ...
    def test_account_creation_invalid_national_id(self):
        account = Account("John", "Doe", "5874589658")
        assert account.national_id == "Invalid"

        account = Account("John", "Doe", "157846987458")
        assert account.national_id == "Invalid"

    def test_account_creation_valid_promo_code(self):
        account = Account("John", "Doe", "87060979383", promo_code="PROM_ABC")
    ...
    def test_account_creation_invalid_promo_code(self): 
        ...
        for code in invalid_codes:
            account = Account("John", "Doe", "87060979383", promo_code=code)
    ...
    def test_account_creation_valid_promo_code_year_before_1960(self):
        ...
        account = Account("John", "Doe", national_id, promo_code="PROM_ABC") 
        assert account.balance == 0
